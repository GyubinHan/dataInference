            ...
            "query":{
                "bool":{
                    "must":[
                        ...
                        {
                        "match":{
                            "container.name":"iot-data-broker-1"
...
# 데이터를 분할하여 작은 데이터프레임으로 나누기
# batch_size = 1000
# es_dfs = [es_dfs[i:i+batch_size] for i in range(0, len(es_df), batch_size)]
...
#     # local
#     table_name = "iotdatabrokerservice"
...
es_df.to_csv("/Users/e8l-20210032/Documents/GyubinHanAI/dataInference/metricset-230704.csv",sep=',',na_rep='NaN')
