            ...
            "query":{
                "bool":{
                    "must":[
                        ...
                        {
                        "match":{
                            "localEndpoint.serviceName":"iotdatabroker-service"
...
zipkin_df.to_csv("/Users/e8l-20210032/Documents/GyubinHanAI/dataInference/zipkin-230704.csv",sep=',',na_rep='NaN')
